...
RSpec.describe AccountsController, type: :controller do
  ...
  describe '#create' do
    ...
    it "invalid signup information" do
      expect {
        ...
        post :create, params: user_params(user), format: :js
    ...
    it "invalid signup with account existed" do
      ...
      expect{
        dup_user = user.dup
        post :create, params: user_params(dup_user), format: :js
  ...
  describe '#update' do 
    ...
    it "should redirect to root path when user signed but not activated" do
      sign_in user
      patch :update, params: profile, format: :js
      expect(response).to have_http_status :redirect
      expect(response).to redirect_to root_path
    ...
    context "update avatar when user has signed in and activated" do
      ...
      it "should has updated with valid avatar" do
        ...
        expect {
          patch :update, params: avatar, format: :js
          user.reload
